...
export async function initScene() {
  ...
  renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, perf.initialMaxPixelRatio ?? 2));
  ...
  const initialShadowMapSize = perf.initialShadowMapSize ?? 1024;
  dirLight.shadow.mapSize.set(initialShadowMapSize, initialShadowMapSize);
